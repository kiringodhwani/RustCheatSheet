...
- [Memory in Rust](#memory-in-rust)
  ...
  - [Stack and Heap](#stack-and-heap)
    ...
    - [Example](#example)
  - [Ownership -- 3 Rules in Rust](#ownership----3-rules-in-rust)
...
- [Option Enum](#option-enum)
  ...
  - [Example 2: Option with Operations](#example-2-option-with-operations)
- [Match Expression](#match-expression)
  - [Example 1: Coin Enum](#example-1-coin-enum)
  - [Example 2: Matching with Bound Values](#example-2-matching-with-bound-values)
  - [Using Match with Option Enum](#using-match-with-option-enum)
...
- [Rust's Module System](#rusts-module-system)
  ...
  - [Privacy Rules with Structs and Enums](#privacy-rules-with-structs-and-enums)
    - [Structs](#example-1-structs)
    - [Enums](#example-2-enums)
...
- [Error Handling in Rust](#error-handling-in-rust)
  ...
  - [Result Enum](#result-enum)
    - [Example 1: Panic on error](#example-1-opening-a-file-and-panicking-if-we-have-the-err-variant)
    - [Example 2: Create file if not found](#example-2-opening-a-file-but-instead-of-panicking-if-open-fails-create-a-new-file)
    - [Example 3: Using closures for cleaner code](#example-3-it-can-be-hard-to-read-with-all-the-nested-match-expressions--use-closures)
    - [Useful Functions on Result Enum](#useful-functions-on-the-result-enum)
